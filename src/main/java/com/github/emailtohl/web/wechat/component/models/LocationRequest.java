 ...
 */
public class LocationRequest extends WechatRequest {
  /**
   ...
   */
  public LocationRequest(String toUserName, String fromUserName, Long createTime, String wechatRequestType) {
